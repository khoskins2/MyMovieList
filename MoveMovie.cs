        ...
        public SkillResponse FunctionHandler(SkillRequest input, ILambdaContext context)
        {
            ...
            if (!sourceList.Contains(movie))
            {
                var errorResponse = new SkillResponse
                {
                    ...
                    Response = new ResponseBody
                    {
                        OutputSpeech = new PlainTextOutputSpeech { Text = $"The item, {movie} cannot be found in {sourceListName}." },
                        ShouldEndSession = true,
                    }
                };
                return errorResponse;
            ...
            var response = new SkillResponse
            {
                ...
                Response = new ResponseBody
                {
                    OutputSpeech = new PlainTextOutputSpeech { Text = $"I've moved {movie} from {sourceListName} to {targetListName}." },
                    ShouldEndSession = true
                }
            };
            return response;
